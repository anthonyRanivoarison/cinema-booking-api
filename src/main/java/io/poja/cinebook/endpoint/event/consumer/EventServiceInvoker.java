package io.poja.cinebook.endpoint.event.consumer;

import io.poja.cinebook.PojaGenerated;
import io.poja.cinebook.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("io.poja.cinebook.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "io.poja.cinebook.service.event."
