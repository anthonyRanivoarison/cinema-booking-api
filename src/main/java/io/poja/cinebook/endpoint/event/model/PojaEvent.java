...
import static io.poja.cinebook.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import io.poja.cinebook.PojaGenerated;
import io.poja.cinebook.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "io.poja.cinebook.event1";
    return "io.poja.cinebook.event2";
  }
}
