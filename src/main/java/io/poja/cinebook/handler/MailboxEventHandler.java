package io.poja.cinebook.handler;

import static io.poja.cinebook.concurrency.ThreadRenamer.renameWorkerThread;
...
import io.poja.cinebook.PojaApplication;
import io.poja.cinebook.PojaGenerated;
import io.poja.cinebook.endpoint.EndpointConf;
import io.poja.cinebook.endpoint.event.EventConf;
import io.poja.cinebook.endpoint.event.consumer.EventConsumer;
import io.poja.cinebook.endpoint.event.consumer.model.ConsumableEvent;
import io.poja.cinebook.endpoint.event.consumer.model.ConsumableEventTyper;
